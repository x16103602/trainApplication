Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "trainapp_#{Rails.env}"
  ...
  API_FB_KEY = Rails.application.secrets.API_FB_KEY
  API_FB_APP_SECRET = Rails.application.secrets.API_FB_APP_SECRET
  API_GOOGLE_KEY = Rails.application.secrets.API_GOOGLE_KEY
